...
Let me read:
 - planning/design/gdd/crafting-system.md (what's designed)
 - planning/production/sprints/sprint-current.md (what's planned)
...
1. Creating ADR: planning/docs/architecture/adr-005-alpha-crafting-scope-reduction.md
2. Updating planning/design/gdd/crafting-system.md with Alpha scope markers
3. Notifying game-designer and lead-programmer to align on new 1.5-week plan
4. Adding to planning/production/milestones/alpha.md as success criteria: 'Crafting pillar demonstrated via core discovery mechanic'
