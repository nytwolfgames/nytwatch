...
**Prototype Path**: `planning/prototypes/[name]/`
**Date**: [YYYY-MM-DD]
**Creator**: [User name]
...
**Code**:
- Location: `planning/prototypes/[name]/src/`
- Status: [Archival | Partial reuse | Full reuse]

**Art/Audio** (if any):
- Location: `planning/prototypes/[name]/assets/`
...
*This concept document was generated by `/reverse-document concept planning/prototypes/[name]`*
