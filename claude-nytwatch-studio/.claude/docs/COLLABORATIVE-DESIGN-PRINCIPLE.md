...
Agent: [Writes src/gameplay/combat/damage_calculator.[ext]]
Agent: "Implemented!"
...
Agent: [Reads design doc]
       "I see the design calls for:
        ...
        1. Should DamageCalculator be a static utility or part of the scene/entity?
...
Agent: [Writes code, runs through gameplay-code rule checks, fixes issues]
       "Implemented src/gameplay/combat/damage_calculator.[ext].
...
Agent: "This implementation requires changes to 3 files:
       1. src/gameplay/inventory.[ext] (core logic)
       2. src/ui/inventory_ui.[ext] (display)
