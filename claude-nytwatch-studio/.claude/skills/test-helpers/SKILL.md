...
Also read:
- `planning/design/gdd/systems-index.md` — to know which systems exist
- In-scope GDD(s) — to understand what data types and values need testing
- `planning/docs/architecture/tr-registry.yaml` — to map requirements to tested systems
...
## Based on: planning/design/gdd/combat.md
