...
For `audit` mode: read `planning/design/gdd/systems-index.md` to get all systems.
...
Glob `planning/production/qa/bugs/*.md` and filter for bugs with a `Status: Closed`
