...
2. Check `planning/docs/engine-reference/godot/breaking-changes.md` for rendering changes
3. Read `planning/docs/engine-reference/godot/modules/rendering.md` for current rendering state
