...
## Architecture Decision Records (`planning/docs/architecture/`)
...
**TR Registry:** `planning/docs/architecture/tr-registry.yaml`
...
## Engine Reference (`planning/docs/engine-reference/`)
...
Current engine: see `planning/docs/engine-reference/godot/VERSION.md`
