...
**Starting State:**
- `planning/design/gdd/movement-system.md` — complete, all 8 sections
- `planning/docs/architecture/movement-adr-001.md` — Status: Accepted
- `planning/production/sprints/sprint-03.md` — lists STORY-MOV-001 in backlog
- `planning/production/stories/STORY-MOV-001.md` — exists but not yet validated
...
**User:**
> /story-readiness planning/production/stories/STORY-MOV-001.md

### Turn 2: Agent Validates the Story

**Agent (via /story-readiness):**
> Reading `planning/production/stories/STORY-MOV-001.md`...
>
...
> - GDD referenced: `planning/design/gdd/movement-system.md` ✅
...
> - ADR referenced: `planning/docs/architecture/movement-adr-001.md` ✅
...
>
> May I write this to `planning/production/stories/STORY-MOV-001.md` and set Status to `ready-for-dev`?
...
> Reading `planning/production/stories/STORY-MOV-001.md`, `planning/design/gdd/movement-system.md`, and `planning/docs/architecture/movement-adr-001.md`...
>
...
**User:**
> I've tested it in the scene — everything works. /story-done planning/production/stories/STORY-MOV-001.md
...
>
> **Phase 1: Story Located** ✅ `planning/production/stories/STORY-MOV-001.md`
>
...
>
> May I update the story status to `Status: Complete` and add Completion Notes, and update `planning/production/sprint-status.yaml`?
...
- `planning/production/sprint-status.yaml` — STORY-MOV-001 set to `done`
