# CNS Skill Testing Framework — Claude Instructions
...
- Skill specs: `CNS Skill Testing Framework/skills/[category]/[name].md`
- Agent specs: `CNS Skill Testing Framework/agents/[tier]/[name].md`
- Catalog: `CNS Skill Testing Framework/catalog.yaml`
- Rubric: `CNS Skill Testing Framework/quality-rubric.md`
...
CNS skills or agents themselves. `/skill-test` and `/skill-improve` will report that
