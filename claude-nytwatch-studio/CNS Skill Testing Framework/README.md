...
> Game developers using CNS don't need it. To remove it entirely:
> `rm -rf "CNS Skill Testing Framework"` — nothing in `.claude/` depends on it.
...
```bash
rm -rf "CNS Skill Testing Framework"
```
