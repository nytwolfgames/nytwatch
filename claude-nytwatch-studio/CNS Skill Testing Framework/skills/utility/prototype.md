...
`planning/prototypes/[mechanic-name]/` and are intentionally disposable — coding standards
...
The skill asks "May I write to `planning/prototypes/[name]/`?" before creating files. If a
...
**Fixture:**
- `planning/prototypes/` directory exists
- No existing prototype for "grapple-hook"

**Input:** `/prototype grapple-hook`

**Expected behavior:**
1. Skill asks "May I write to `planning/prototypes/grapple-hook/`?"
2. After approval: creates `planning/prototypes/grapple-hook/` directory and basic
...
4. Skill produces `planning/prototypes/grapple-hook/findings.md` with:
   - What was tested
   - What worked
   - What didn't work
...
**Assertions:**
- [ ] "May I write to `planning/prototypes/grapple-hook/`?" is asked before any files are created
- [ ] Implementation is isolated to `planning/prototypes/` (not `src/`)
...
**Fixture:**
- `planning/prototypes/grapple-hook/` already exists from a previous prototype session
- It contains a basic implementation and a findings.md

**Input:** `/prototype grapple-hook`

**Expected behavior:**
1. Skill detects existing `planning/prototypes/grapple-hook/` directory
...
3. Skill presents 3 options:
   ...
   - Replace: start fresh (asks "May I replace `planning/prototypes/grapple-hook/`?")
   - Archive: move to `planning/prototypes/archive/grapple-hook/` and start fresh
...
- [ ] Asks "May I write to `planning/prototypes/[name]/`?" before creating any files
- [ ] Creates all files under `planning/prototypes/` (not `src/`)
