...
**Fixture:**
- `planning/design/gdd/enemies.md` exists with enemy variants defined
- `planning/design/art-bible.md` exists with color palette and style notes
...
**Fixture:**
- `planning/design/gdd/player.md` exists
- `planning/design/art-bible.md` does NOT exist
