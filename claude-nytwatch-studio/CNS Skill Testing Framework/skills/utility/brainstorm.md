...
a structured `planning/design/gdd/game-concept.md` document. The skill is collaborative —
...
before writing `planning/design/gdd/game-concept.md`.
...
**Fixture:**
- No existing `planning/design/gdd/game-concept.md`
...
7. Skill asks "May I write `planning/design/gdd/game-concept.md`?"
...
- [ ] "May I write `planning/design/gdd/game-concept.md`?" is asked before writing
...
5. "May I write `planning/design/gdd/game-concept.md`?" asked after confirmation
...
4. "May I write `planning/design/gdd/game-concept.md`?" asked
...
- [ ] "May I write `planning/design/gdd/game-concept.md`?" asked before writing
